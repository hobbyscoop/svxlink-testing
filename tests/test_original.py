...
class Test(unittest.TestCase):
    ...
    def test_switchover_by_squelch(self):
        ...
        self.assertEqual(self.env.wait_for_remote_by_tone("remote1", 5), True, "remote1 should still be audible")
        ...
        self.assertEqual(self.env.wait_for_remote_by_tone("remote1", 5), True, "remote2 should now be audible")
